...
public class SimpleClassLoader extends ClassLoader {
    ...
    public Class<?> lookupClass(String name, byte[] bytes) {
        ...
        final ProtectionDomain protDomain = new ProtectionDomain(getClass().getProtectionDomain().getCodeSource(), perms, this, getClass().getProtectionDomain().getPrincipals());
