package net.runelite.client.plugins.ethan.Packets;

import net.runelite.client.plugins.ethan.EthanApiPlugin.Collections.query.TileObjectQuery;
import net.runelite.client.plugins.ethan.PacketUtils.PacketDef;
import net.runelite.client.plugins.ethan.PacketUtils.PacketReflection;
...
import static net.runelite.client.plugins.ethan.PacketUtils.PacketReflection.client;
